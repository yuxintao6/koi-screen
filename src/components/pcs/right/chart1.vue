  ...
  methods: {
    ...
    updateChart() {
      ...
      const dataOption = {
          legend: {
            right: '5%',
            data: ['负载A相电流', '负载A相电流', '负载C相电流','负载N相电流','输出A相电流', '输出B相电流', '输出C相电流','输出N相电流']
          },
          xAxis: {
            type: 'category',
            boundaryGap: false,
          ...
          series: [
            ...
            },
            {
              ...
              type: 'line',
              stack: 'Total',
              data: [255, 245, 545, 455, 445, 45, 785, 654, 254, 554, 245, 521, 415, 457, 145, 245, 145, 758, 458, 415, 145, 144, 654, 254, 245]
            },
            {
              name: '输出B相电流',
              type: 'line',
              stack: 'Total',
              data: [255, 548, 256, 784, 642, 245, 417, 242, 355, 451, 544, 254, 145, 248, 415, 414, 547, 245, 355, 244, 258, 777, 665, 222, 333]
            },
            {
              name: '输出C相电流',
              type: 'line',
              stack: 'Total',
              data: [454, 454, 557, 57, 547, 887, 997, 554, 784, 785, 784, 784, 784, 784, 878, 554, 451, 457, 356, 457, 547, 453, 451, 457, 457]
            },
            {
              name: '输出N相电流',
              type: 'line',
              stack: 'Total',
              data: [325, 457, 865, 545, 352, 547, 557, 634, 784, 578, 548, 357, 478, 578, 547, 237, 475, 478, 895, 478, 898, 788, 568, 688, 458]
            },
          ]                              
      };
      // 图表数据变化配置
